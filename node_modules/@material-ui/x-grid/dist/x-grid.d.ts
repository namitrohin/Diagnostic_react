 ...
 * The full grid API.
 */
interface GridApi extends GridCoreApi, GridComponentsApi, GridStateApi, GridDensityApi, GridEventsApi, GridRowApi, GridEditRowApi, GridParamsApi, GridColumnApi, GridSelectionApi, GridSortApi, GridVirtualizationApi, GridPaginationApi, GridCsvExportApi, GridFocusApi, FilterApi, ColumnMenuApi, PreferencesPanelApi, LocaleTextApi {
}
...
declare const GridColumnHeaderItem: React$1.MemoExoticComponent<({ column, colIndex, isDragging, isResizing, sortDirection, sortIndex, options, filterItemsCounter, hasFocus, tabIndex, }: GridColumnHeaderItemProps) => JSX.Element>;
...
declare const gridFocusCellSelector: reselect.OutputSelector<GridState, GridCellIndexCoordinates | null, (res: GridFocusState) => GridCellIndexCoordinates | null>;
declare const gridFocusColumnHeaderSelector: reselect.OutputSelector<GridState, GridColumnHeaderIndexCoordinates | null, (res: GridFocusState) => GridColumnHeaderIndexCoordinates | null>;
declare const gridTabIndexStateSelector: (state: GridState) => GridTabIndexState;
declare const gridTabIndexCellSelector: reselect.OutputSelector<GridState, GridCellIndexCoordinates | null, (res: GridTabIndexState) => GridCellIndexCoordinates | null>;
declare const gridTabIndexColumnHeaderSelector: reselect.OutputSelector<GridState, GridColumnHeaderIndexCoordinates | null, (res: GridTabIndexState) => GridColumnHeaderIndexCoordinates | null>;
